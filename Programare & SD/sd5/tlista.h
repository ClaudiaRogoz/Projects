...
typedef int (*TFPrelEL)(AEL e,AEL f);  /* functie prelucrare element lista */

/*-- operatii elementare --*/
ALista CautLeg(ALista ,TFPrelEL );
int LungLR(TLista ); // numarul de elemente recursiv
