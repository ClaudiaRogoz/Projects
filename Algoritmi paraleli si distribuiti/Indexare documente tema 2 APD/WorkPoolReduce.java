...
public class WorkPoolReduce {
	...
	LinkedList<PartialSolutionReduce> tasks = new LinkedList<PartialSolutionReduce>();
	 ...
	 */
	public WorkPoolReduce(int nThreads,HashMap<String,String> result) {
	 ...
	 */
	public synchronized PartialSolutionReduce getWork() {
	 ...
	 */
	synchronized void putWork(PartialSolutionReduce sp) {
